 ...
 *
 * Some of these fail today, on purpose. `allTools` is 16 stubs; as Vicko fills each one in, the
 * assertions below go green one by one and the suite doubles as the checklist.
 */
