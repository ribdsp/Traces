...
This project handles session recordings, and a recording is a full reconstruction of a page and
everything that was on it. **Publishing a recording of a real person's session — in an issue, a pull
request, a discussion, or a linked file — is treated as publishing their private information**, and
falls under the standards above rather than under a technical rule.

Use the synthetic recordings generated by [`bugbait/`](bugbait). If you need to demonstrate a bug that
only reproduces on a real site, describe it; don't attach the recording. See
[SECURITY.md](SECURITY.md) if you believe one has already been published here.
...
by contacting [@ribdsp](https://github.com/ribdsp) on GitHub. All complaints will be reviewed and
investigated promptly and fairly.

All community leaders are obligated to respect the privacy and security of the reporter of any
incident.

If a report concerns a maintainer, or you would rather not contact a maintainer directly, use
[GitHub's own abuse reporting](https://github.com/contact/report-abuse), which reaches GitHub Support
